...
#define ForegroundStarImage @"ReportRepair_start_evaluate"
#define BackgroundStarImage @"ReportRepair_start_unEvaluate"
...
-(instancetype)initWithFrame:(CGRect)frame numberOfStars:(NSInteger)numberOfStars rateStyle:(RateStyle)rateStyle isAnination:(BOOL)isAnimation finish:(finishBlock)finish normalImage:(UIImage *)normalImage selectedImage:(UIImage *)selectedImage{
    if (self = [super initWithFrame:frame]) {
        self.foregroundImage = normalImage;
...
-(void)createStarView{
    ...
    self.foregroundStarView = [self createStarViewWithImage:self.foregroundImage?:[UIImage imageNamed:ForegroundStarImage]];
    self.backgroundStarView = [self createStarViewWithImage:self.backgroundImage?:[UIImage imageNamed:BackgroundStarImage]];
...
- (UIView *)createStarViewWithImage:(UIImage *)aimage {
