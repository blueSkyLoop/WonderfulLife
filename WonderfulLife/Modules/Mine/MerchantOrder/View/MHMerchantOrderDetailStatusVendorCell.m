//
//  MHMerchantOrderDetailStatusVendorCell.m
//  WonderfulLife
//
...
@interface MHMerchantOrderDetailStatusVendorCell ()
...
@property (weak, nonatomic) IBOutlet UILabel *usersOfOrderName;
@property (weak, nonatomic) IBOutlet UILabel *usersOfOrderPhone;
@property (weak, nonatomic) IBOutlet UIImageView *statusImage;

@end

@implementation MHMerchantOrderDetailStatusVendorCell
...
- (void)mh_configCellWithInfor:(MHMerchantOrderDetailModel *)model {
    ...
    self.usersOfOrderName.text = model.nickname;
    self.usersOfOrderPhone.text = model.login_username;
