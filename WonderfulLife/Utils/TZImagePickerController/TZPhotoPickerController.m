...
- (void)addRightBarItem{
    ...
    [cancelBtn setTitle:imagePickerVc.cancelBtnTitleStr forState:UIControlStateNormal];
    [cancelBtn sizeToFit];
    [cancelBtn addTarget:imagePickerVc action:@selector(cancelButtonClick) forControlEvents:UIControlEventTouchUpInside];
